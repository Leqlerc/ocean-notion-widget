...
- Notion still backs Tasks, Projects, Athletics Daily logs, Training Sets, Exercises, and Daily-log habits. Eight independently sourced academic Events are retained for now. Nutrition, sleep, maintenance, reflections, layout/appearance and submission confirmation retain existing device-local storage. No Neon cutover, schema migration, or broad provider rewrite.
