...
const CalendarSemantics = (() => {
  const categories = {
    exam:{key:'exam',label:'Exam',priority:6},
    assessment:{key:'assessment',label:'Quiz / CFU / practical',short:'Assessment',priority:5},
  ...
  function classify(event) {
    ...
    if (/\b(quiz|cfu|practical)\b/i.test(text)) return categories.assessment;
