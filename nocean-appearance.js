...
const NOceanAppearance=(()=>{
  ...
  function validate(value,fallback='none') {
    ...
    return {image:Object.hasOwn(assets,v.image)?v.image:fallback,visibility:Object.hasOwn(visibility,v.visibility)?v.visibility:'Medium',tint:Object.hasOwn(tints,v.tint)?v.tint:'Ocean',rotatingMessages:v.rotatingMessages!==false,message:typeof v.message==='string'?v.message.slice(0,180):''};
  }
  ...
  function values(){return {...(settings[active]||{}),rotatingMessages:document.getElementById('rotatingMessages').checked,message:document.getElementById('welcomeMessage').value,image:document.getElementById('artImage').value,visibility:document.getElementById('artVisibility').value,tint:document.getElementById('artTint').value};}
  ...
  function open(id){
    ...
    active=id;document.getElementById('welcomeSettings').hidden=id!=='welcome';const value=validate(settings[id],target.dataset.defaultArt||'none');
    ...
    document.getElementById('rotatingMessages').checked=value.rotatingMessages;document.getElementById('welcomeMessage').value=value.message;document.getElementById('welcomeMessage').disabled=value.rotatingMessages;
