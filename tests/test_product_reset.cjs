...
assert.deepEqual(JSON.parse(JSON.stringify(context.store.settings().appearance)),{topBiomeHeight:176,cardOpacity:100,accent:'green',difficultyColors:'off',cardArt:{tasks:'none',deadlines:'none',events:'none',campus:'none',calendar:'none'}});
