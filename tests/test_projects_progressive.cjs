...
(async()=>{
 ...
 assert.match($('projectGrid').textContent,/Fast selector/);assert.match($('projectGrid').textContent,/Loading progress/);assert.match($('projectDetail').textContent,/Loading task progress/);
